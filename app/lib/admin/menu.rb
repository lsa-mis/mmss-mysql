...
class Admin::Menu
  ...
  GROUPS = [
    ...
    Group.new(label: 'Applicant Info', items: [
      ...
      Item.new(label: 'Applicant Details', route: :admin_applicant_details_path),
      ...
      Item.new(label: 'Financial Aid Requests', route: :admin_financial_aid_requests_path),
      Item.new(label: 'Payments', route: :admin_payments_path),
